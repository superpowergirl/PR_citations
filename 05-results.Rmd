...
```{r echo=FALSE, warning=FALSE, message=FALSE}
ggplot(citations_count, aes(x=n, y=..density..)) +
  geom_density(color="blue")+ scale_x_log10() + 
  xlab("Number of citations received by articles - Log scale")+
  ylab("Count of articles receiving a specific number of citations")+
  labs(title="Density Histogram of citations received by papers")+theme_bw()+theme(plot.title = element_text(hjust=0.5))+
