...
We then ask the question - are there any patterns associated with journal categories?
...
plot_ly(
          ...
          # Hover text:
              hoverinfo = 'text',
          text = ~paste(Year,":", total_n)
      ) %>% layout(title = "Number of Citations Received by Publication Year", yaxis=list(title=""))
